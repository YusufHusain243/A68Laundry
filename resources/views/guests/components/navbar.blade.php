                        ...
                        <li class="nav-item ms-xl-auto">
                            @if (Auth::check())
                                <div class="d-flex justify-content-between gap-2">
                                    ...
                                    <div class="dropdown">
                                        <a href="#"
                                            class="px-3 text-body-emphasis bg-body-secondary-hover border nav-link rounded-3 text-base leading-6 fw-semibold text-center dropdown-toggle"
